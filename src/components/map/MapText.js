...
const MapText = () => {
  ...
  return (
    <Text>
      <h2>Location</h2>
      <p>
        If you are flying in, Torino is the closest airport approx 1,5 hour
        drive. Milano’s airports (Linate, Malpensa) and Bergamo is approx 2 -
        2,5 hours drive. The house is approx 3 km from Champoluc village and 1
        km from the Frachey lift station, that takes you to the
        {' '}
